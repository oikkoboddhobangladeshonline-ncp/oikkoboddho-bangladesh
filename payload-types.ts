...
export interface Config {
  ...
  collectionsSelect: {
    ...
    cctv_locations: CctvLocationsSelect<false> | CctvLocationsSelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "cctv_locations".
 */
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'cctv_locations';
        value: number | CctvLocation;
      } | null)
    | ({
        relationTo: 'media';
        value: number | Media;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "cctv_locations_select".
 */
export interface CctvLocationsSelect<T extends boolean = true> {
  name?: T;
  url?: T;
  location?: T;
  status?: T;
